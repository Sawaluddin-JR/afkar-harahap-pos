...
class ProductCart extends Component
{
    ...
    public function calculate($product, $new_price = null) {
        ...
        // if (moduleStatusCheck('WholeSale')) {
        //     $user = auth()->user();

        //     if ($user->role->type == 'customer' && $user->is_active_wholesale) {
        //         $wholesalePrice = productWholesalePrice($product['id'], $user->id);
        //         if ($wholesalePrice) {
    ...
    // private function updateCartOptions($row_id, $product_id, $cart_item, $discount_amount) {
    //     Cart::instance($this->cart_instance)
    //         ->update($row_id, [
    //             'options' => [
    //                 'sub_total'             => $this->calculate($cart_item, $cart_item->price)['sub_total'],
    //                 'code'                  => $cart_item->options->code,
    //                 'stock'                 => $cart_item->options->stock,
    //                 'unit'                  => $cart_item->options->unit,
    //                 'product_tax'           => $cart_item->options->product_tax,
